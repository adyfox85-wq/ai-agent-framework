...
| PH-001 | v0.5 PH-1 Portability Hardening：Planner bootstrap + replaceable role contracts（入口 = START_HERE_FOR_NEW_PLANNER.md；权威 = docs/internal/AAF_ROLE_CONTRACTS.md；record = docs/internal/AAF-v0.5-PH1-PLANNER-BOOTSTRAP-ROLE-CONTRACTS-001-REPORT.md） | STARTED (docs-only; route WB/Codex PENDING, 2026-09-05) | P1 |

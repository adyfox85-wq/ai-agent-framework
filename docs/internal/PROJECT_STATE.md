...
A2 Status: STARTED（2026-08-31，AAF-v0.5-A2-SHADOW-ROUTING-001：首片 deterministic
  shadow-selection engine 交付；A2 未 COMPLETE——运行期影子观测/集成（shadow observation
  写入、实况 qualification 观测）留待后续 A2 slice）

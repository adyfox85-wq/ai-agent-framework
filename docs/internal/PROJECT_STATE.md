...
Next mainline: v0.5 -> A2 Shadow Routing = CLOSED / COMPLETE / SYNCED（2026-08-31
  ...
  真实 probe 资格化，见下方 A2+ Status；后续候选 slice 待规划）；后续候选 = A3
  Hermes Free Auto Routing（actual routing，CAP-003，未启动，NOT IMPLEMENTED）；

...
Status: A0 = CLOSED / COMPLETE（2026-08-30，AAF-v0.5-A0-PAID-GUARD-001-CLOSE-001 正式关闭：
  ...
  工作树 tracked CLEAN（untracked 仅 PRE_ALLOWED_UNTRACKED 常驻项）；A1 未启动）
Next (A1): Registry + Risk —— Hermes candidate Tier registry / Selection Engine / Shadow Routing /
  WorkBuddy 经济路由 / Codex 成本优化 / 精确计价 / Cost Gate UX（A1 尚未开始；Hermes
